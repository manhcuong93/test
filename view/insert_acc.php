        ...
        <div class="wrap">
            ...
            <form method="post" action="admincontroller.php">
                ...
                <div class="col_1_of_2 span_1_of_2">
                    <input type='hidden' name='action' placeholdere='add_acc'/>
                ...
                <div class="col_1_of_2 span_1_of_2">	
                    ...
                    <div><select id="country" name="country" onchange="change_country(this.value)" class="frm-field required">
                            ...
                            <option value="AX">Ailand Islands</option>
                    ...
                    <input type="text" name="code" class="code"> - <input type="text" name="phone" class="number">
